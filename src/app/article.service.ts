...
export class ArticleService {
  ...
  private originalList = this.list;
  ...
  search(keyword: string) {
    ...
    // );
    return this.articleSearchService.search(keyword, this.originalList);
  }
  ...
  search2(keyword: string) {
    ...
    //   );
    // }
    this.list = this.articleSearchService.search(keyword, this.originalList);
  }
}
